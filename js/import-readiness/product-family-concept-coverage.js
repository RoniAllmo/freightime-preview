...
export const FAMILY_CONCEPT_COVERAGE = Object.freeze([
  ...
  Object.freeze({ familyValue: 'personal_protective_equipment', status: 'B', coverageSource: 'alias_supplement', matrixIds: Object.freeze(['additional-consumer-products-06', 'additional-consumer-products-10']), justification: 'Matrix aliases plus a pre-existing sports-vs-occupational presentation-alias-supplement already provide safe, reviewed coverage. Widened (PKG-FB04-COMPLETE-HELMET-DOMAIN-V1) to also include the dedicated helmet family, since this checkbox\'s own candidate set now spans both rows so free text can disambiguate a general-PPE description from a complete-helmet description.' }),
  Object.freeze({ familyValue: 'protective_helmets', status: 'A', coverageSource: 'matrix', matrixIds: Object.freeze(['additional-consumer-products-10']), justification: 'Dedicated standalone helmet family (PKG-FB04-COMPLETE-HELMET-DOMAIN-V1, completed): the matrix carries a full curated alias set for complete helmets (including complete replacement helmets), parts/toy/decorative exclusions, PPE alias transfer, transport-family collision protection, and a dedicated Standards Institution guidance note.' }),
