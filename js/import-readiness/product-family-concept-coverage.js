...
export const FAMILY_CONCEPT_COVERAGE = Object.freeze([
  ...
  Object.freeze({ familyValue: 'protective_helmets', status: 'A', coverageSource: 'matrix', matrixIds: Object.freeze(['additional-consumer-products-10']), justification: 'New dedicated standalone helmet family (PKG-FB04 Package 0); the matrix alias directly names the concrete product. Alias expansion, collision protection, and dedicated guidance are separate, not-yet-implemented packages.' }),
