/**
 * Evidence package intake slot: vehicle-installed-product.
 *
 * =====================================================================
 * INTENTIONALLY EMPTY -- placeholder scaffolding only.
 *
 * This file is the EXACT place the product owner should fill in a
 * reviewed regulatory evidence package for the
 * `vehicle_installed_product` candidate (the existing disabled
 * `RS-VEHICLE-001` entry in `../rules-registry.js`) once real,
 * human-verified source material is available. Nothing below is real
 * regulatory content: every field is an explicit empty/placeholder
 * value, never an invented fact, number, URL, or Hebrew wording. Do
 * NOT treat any value in this file as a real claim about Israeli
 * import regulation.
 *
...
export const VEHICLE_INSTALLED_PRODUCT_EVIDENCE = Object.freeze({
  ...
  ruleId: 'RS-VEHICLE-001',
  publicCategory: 'vehicle_installed_product',
  ...
  internalName: 'vehicle-installed-product',
